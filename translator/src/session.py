...
class GeminiSession:
    ...
    def _build_setup_payload(self) -> dict:
        ...
        base_instruction = (
            ...
            "own voice completely intact. You MUST match the speaking speed "
            "(words per minute) of the original speaker: if they speak fast, "
            "you speak fast; if they speak slow, you speak slow. "
